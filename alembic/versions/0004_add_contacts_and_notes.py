...
def upgrade() -> None:
    ...
    op.add_column("projects", sa.Column("contact_email", sa.String(length=255), nullable=True))
    op.add_column("projects", sa.Column("contact_phone", sa.String(length=50), nullable=True))
